...
<div class="wrap">
		<div class="logo">
			<a href="\">
				...
				<li >
				<a href="#" >Hi, <?php
					echo strip_tags(str_limit($data -> nama, $limit = 13, $end = '...') ) ?></a>
				</li>
				<li >
...
<div class="container">
  @foreach($useraccount as $useraccount)
	...
	<div class="row">
      <!-- left column -->
      <form  class="form-horizontal" method ="POST" action="/editprofile/ubahpassword/submit" enctype="multipart/form-data">
  			{{ csrf_field() }}
      ...
      <div class="col-md-9 personal-info">
        ...
        <form class="form-horizontal" role="form">
          <div class="form-group">
            ...
            <div class="col-lg-8">
              <input class="form-control" type="text" value="{{$useraccount->nama}}" disabled>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-lg-8">
              <input class="form-control" type="text" value="{{$useraccount->email}}" disabled>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-8">
              <input class="form-control" type="text" value="{{$useraccount->username}}" disabled>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-md-8">
              <input class="form-control" name="passwordp" type="password" id="newpass">
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-md-8">
              ...
              <input type="button" class="btn btn-primary" value="Kembali" onclick="window.location.href='{{ url('editprofile') }}'" />
              <span></span>
...
, confirm_password = document.getElementById("confirmnewpass");
