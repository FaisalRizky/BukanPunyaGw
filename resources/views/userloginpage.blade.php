...
<body>
	...
	<div class="limiter">
		<div class="container-login100">
          ...
          <form class="login100-form validate-form" method ="POST" action="/userlogin/submit">
            {{ csrf_field() }}
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid Username is required">
						<input class="input100" type="text" name="imel" placeholder="Username or Email">
					...
					<br>
					<input type="button" class="login100-form-btn" value="Daftar" onclick="window.location.href='{{ url('pendaftaran') }}'" />
				</form>
			</div>
		</div>
	</div>
