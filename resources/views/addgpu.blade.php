...
@endif
       <div class="kotak">
		...
		<form  method ="POST" action="/postgpu/submit" enctype="multipart/form-data">
			{{ csrf_field() }}
		<p><h>Nama GPU       : </h>	<select name="namep" required></p>
    <option value="Nvidia">Nvidia</option>
    <option value="Intel">Intel</option>
	  <option value="AMD">AMD</option>
		</select>
		<p><h>Seri           : </h> <input type="text" name="seriesp" placeholder="Geforce GTX, HD, UHD, Radeon, etc" required/>
		<p><h>Tipe           : </h> <input type="text" name="tipep" placeholder="1060, 4000, etc" required/>
    <p><h>Arsitektur   : </h> <input type="text" name="archp" required/></p>
		<p><h>Kecepatan      : </h> <input type="text" name="speedp" required/> MHz</p>
    <p><h>Boost      : </h> <input type="text" name="boostp" required/> MHz</p>
	  <p><h>Manufaktur     : </h> <input type="text" name="manufakturp" required/> nm</p>
		<p><h>Tipe Memori       		 : </h> <input type="text" name="memtypep" required/>
    <p><h>Memori Grafik   : </h> <input type="text" name="memoryp" required/> GB</p>
    <p><h>Kecepatan Memori   : </h> <input type="text" name="memspeedp" required/> MHz</p>
    <p><h>Memori Bus   : </h> <input type="text" name="membusp" required/> Bit</p>
    <p><h>Directx   : </h> <input type="text" name="directxp" required/></p>
