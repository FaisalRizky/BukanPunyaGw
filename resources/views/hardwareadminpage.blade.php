...
<div class="note" style="font-size:18px;">
	<center>
 <strong>Superadmin Required</strong>
...
<div class="linknavigasi">
	...
	@else
				...
				<li class="dropdown"><a class="dropdown-toggle" href="#"  data-toggle="dropdown">Dashboard</a>
					<ul class="dropdown-menu" style="background:#1a1a1a; width:auto; position:absolute; margin-top:3.5%; margin-left: 58%; padding-right:37%; padding-left:37%;">
						<div class="buathover">
		...
		<div class="row">
			  <div class="col-md-12" style="background-color:black;">
					...
					@if(session()->has('superadmin') || session()->has('hwadmin'))
          <p><h1 style="color:white; font-family:Verdana;">Welcome to Hardware Admin Special Page {{$profile->penulis}} :D</h1></p>
					@endif
					@endforeach
					<br>
					<br>
