...
<div class="pemisah" style="border-bottom:2px red solid;">
          ...
          <h1 style="font-family:arvo; font-weight:bold;"><center>List Cpu</center></h1>

        </div>

         <div class="col-md-5" style="background:#222; border-radius:5px; margin-top:2%;">
           <h1 style="font-family:Bahianita; background:#640202"><center>Intel Series</center></h1>
           @foreach($cpu as $cpu)
           <div class="hwlink"> <a href="cpu/{{$cpu -> id_cpu}}">{{$cpu->cpu_nama}}&nbsp;{{$cpu->cpu_series}}&nbsp;{{$cpu->cpu_tipe}}</a></div>
           @endforeach
...
<div class="col-md-5" style="background:#222; border-radius:5px; margin-top:2%;">
  ...
  @foreach($cpu1 as $cpu1)
  <div class="hwlink"> <a href="cpu/{{$cpu1 -> id_cpu}}">{{$cpu1->cpu_nama}}&nbsp;{{$cpu1->cpu_series}}&nbsp;{{$cpu1->cpu_tipe}}</a></div>
@endforeach
